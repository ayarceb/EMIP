...
class UtopyaInstall( utopya_rc.UtopyaRc ) :
    ...
    If a file has an extension that is recoqnized as a package
    ...
    should be enclosed by square brackets::
        ...
        ! package files, eventually extra file if present:
    ...
    def InstallSet( self, setname, indent='' ) :
        ...
        for t in tt :
            ...
            for fname_template in fnames :
                ...
                # renew?
                if renew or ( (not os.path.isfile(fname)) and (not os.path.isfile(fname+'.content')) ) :
                    # info ..
                    ...
                    elif os.path.isfile(fname+'.content') :
                        self.logger.info( indent+'  found  %s.content, already unpacked ...' % fname )
                    #endif
                #endif
    ...
    def GetFile( self, path, filename, optional=False, touch=False, verbose=False, indent='' ) :
        ...
        # get file:
        gss.Get( sourcefile, filename, verbose=verbose )
    ...
    def Unpack( self, filename, touch=False, indent='' ) :
        ...
        and an empty file with a listing of the content is written instead.
        ...
        if command is not None :
            ...
            with open( filename+'.content', 'w' ) as f :
