...
# -*- coding: utf-8 -*-
#
# EMIP documentation build configuration file, created by
# sphinx-quickstart on Fri Oct 26 15:18:11 2018.
#
...
# Default options for autodoc entries, see:
...
html_theme = 'bizstyle'  # comment the 'html_sidebars' section!
...
latex_documents = [
    (master_doc, 'EMIP.tex', 'EMIP Documentation',
     'Arjo Segers', 'manual'),
]
...
man_pages = [
    (master_doc, 'emip', 'EMIP Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'EMIP', 'EMIP Documentation',
     author, 'EMIP', 'One line description of project.',
     'Miscellaneous'),
]
